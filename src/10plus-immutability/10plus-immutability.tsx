...
let man7FullCopy = {
    ...
    mother: {
        ...
        parents: man7.mother.parents.map(par =>
            ({
                ...par,
                favoriteDish: {
                    ...par.favoriteDish,
                    ingredients: par.favoriteDish.ingredients.map(ingr =>
                        ({...ingr})
                    )
                }
            })
...
man7FullCopy.mother.parents[1].favoriteDish.ingredients[1].amount=10

console.log(
    man7.mother.parents[1].favoriteDish.ingredients[1].amount,
    man7FullCopy.mother.parents[1].favoriteDish.ingredients[1].amount
    )
